    ...
    for ball in balls:
        ...
        if dist + BALL_RADIUS > CIRCLE_RADIUS:
            ...
            if ball.is_in == True: 
                ...
                proj_v_t = (np.dot(ball.v, t)/np.dot(t, t)) * t #hinh chieu tu v xuong t
                ball.v = 2 * proj_v_t - ball.v #update van toc bong 
                ball.v += t * spinning_speed      # v = r.w, w: toc do quay = spinning_speed
